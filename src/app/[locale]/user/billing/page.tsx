      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between px-2">
          <div className="text-muted-foreground text-sm">
            {t('components.dataTable.page', { page: pageNumber, total: pagination.totalPages })}
          </div>
          <div className="flex items-center space-x-2">
            ...
            >
              <Link href={`?page=${pageNumber - 1}`}>{t('components.dataTable.previousPage')}</Link>
            </Button>
            <Button
              variant="outline"
              size="sm"
              ...
              className="hover:bg-muted"
            >
              <Link href={`?page=${pageNumber + 1}`}>{t('components.dataTable.nextPage')}</Link>
            </Button>
          </div>
        </div>
      </div>
